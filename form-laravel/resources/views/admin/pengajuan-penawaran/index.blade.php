  ...
  <div class="card-header">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6 col-sm-12 mb-2">
        <form action="{{ route('admin.pengajuan-penawaran.index') }}" method="GET" class="d-flex">
      ...
      <div class="col-md-3 col-sm-6 mb-2">
        <form action="{{ route('admin.pengajuan-penawaran.index') }}" method="GET">
      ...
      <div class="col-md-3 col-sm-6 text-md-end text-sm-start mb-2">
        <a href="{{ route('admin.pengajuan-penawaran.create') }}" class="btn btn-success btn-sm ms-md-2">
          + Tambah Penawaran
        </a>
      </div>
    </div>
