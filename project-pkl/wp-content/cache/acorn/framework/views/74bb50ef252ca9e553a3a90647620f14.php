<footer class="bg-neutral-900 text-gray-300 relative overflow-hidden"> 
    ...
    <div class="absolute -bottom-12 -left-12 opacity-10 pointer-events-none">
        <img src="<?php echo e(Vite::asset('resources/images/Logo.svg')); ?>" alt="Logo Rasa Nusa" class="w-64 md:w-80 lg:w-[400px]">
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-10">
            ...
            <div class="md:w-4/5 relative z-10">
                ...
                <div class="flex items-center gap-3 mb-5">
                    <img src="<?php echo e(Vite::asset('resources/images/logofooter.png')); ?>" alt="Rasa Nusa" class="h-8">
                </div>
                ...
                <div class="flex gap-4 text-gray-400">
                    <a href="#" class="hover:text-white transition">
                        <img src="<?php echo e(Vite::asset('resources/images/tiktok.svg')); ?>" alt="TikTok" class="h-6 w-6">
                    </a>
                    <a href="#" class="hover:text-white transition">
                        <img src="<?php echo e(Vite::asset('resources/images/whatsapp.svg')); ?>" alt="WhatsApp" class="h-6 w-6">
                    </a>
                    <a href="#" class="hover:text-white transition">
                        <img src="<?php echo e(Vite::asset('resources/images/facebook.svg')); ?>" alt="Facebook" class="h-6 w-6">
                    </a>
                    <a href="#" class="hover:text-white transition">
                        <img src="<?php echo e(Vite::asset('resources/images/instagram.svg')); ?>" alt="Instagram" class="h-6 w-6">
                    </a>
                </div>
            </div>
...
<?php /**PATH D:\laragon\www\project-pkl\wp-content\themes\riset-wordpress-sage\resources\views/sections/footer.blade.php ENDPATH**/ ?>